...
mean_hitting_times = np.loadtxt(f'RESULTS_mean_hitting_time_PVM_gamma2_{gamma_2:.6f}_N_{num_sites}_resolution_{num_phi_points}x{num_tau_points}_{M}_runs.txt')
